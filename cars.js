...
(function () {
    ...
    tableViewButton.addEventListener("click", function () {
        ...
        if (DOM.whatToDraw === "table") {
            ...
            const sunroofLable = document.createElement("label")
            checkboxesDiv.appendChild(sunroofLable)
            sunroofLable.innerHTML = "SunRoof:"
            sunroofLable.appendChild(SunRoofCheckbox)
            SunRoofCheckbox.type = "checkbox"

            SunRoofCheckbox.addEventListener('change', function (event) {
...
function getRowHeaderItem(headers) {
    const ths = headers.filter((header) => {
